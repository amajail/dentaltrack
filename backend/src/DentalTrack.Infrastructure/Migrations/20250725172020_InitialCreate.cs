        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Metadata_Width = table.Column<int>(type: "int", nullable: false),
                    Metadata_Height = table.Column<int>(type: "int", nullable: false),
                    Metadata_CameraModel = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Metadata_CameraMake = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Metadata_DateTaken = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Metadata_Location = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Metadata_ExposureTime = table.Column<double>(type: "float", nullable: true),
                    Metadata_FNumber = table.Column<double>(type: "float", nullable: true),
                    Metadata_Iso = table.Column<int>(type: "int", nullable: true),
                    Metadata_Flash = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Metadata_FocalLength = table.Column<double>(type: "float", nullable: true),
                    Type = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Photos_Treatments_TreatmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Analyses_Photos_PhotoId",
                        column: x => x.PhotoId,
                        principalTable: "Photos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Analyses_Treatments_TreatmentId",
                        column: x => x.TreatmentId,
                        principalTable: "Treatments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Photos_Quality",
                table: "Photos",
                column: "Quality");

            migrationBuilder.CreateIndex(
                name: "IX_Photos_TreatmentId",
                table: "Photos",
                column: "TreatmentId");
